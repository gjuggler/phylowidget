 ...
 * 
 */
public class PTextInput implements BlinkListener, MouseListener, KeyListener, MouseMotionListener
{
	protected PApplet p;
	...
	public PTextInput(PApplet applet, int size, float x, float y, float w)
	{
		...
		p2 = p.createGraphics((int)(w * 1.5), (int)th+1,
				PApplet.JAVA2D);
...
//					getPosForIndex(caret) + textOffset, th);
	...
	{
		if (!blinker.isOn || !FocusManager.isFocused(this)
				|| selHi - selLo != 0)
			return;
		p.stroke(color);
		p.strokeWeight(1);
...
//	}
	...
	public void mouseEvent(MouseEvent e)
	{
		...
		} else if (e.getID() == MouseEvent.MOUSE_PRESSED)
		{
			...
			if (FocusManager.removeFromFocus(this))
			{
