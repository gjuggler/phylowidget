...
// Model.
	...
	public PRadialMenuSegment[] shapes = new PRadialMenuSegment[0];
...
// Statics & Constants.
	...
	public PRadialMenu(PApplet p)
	{
		this(p,20,20,40);
	}
	
	public PRadialMenu(PApplet p, float x, float y, float r)
	{
		this.p = p;
	...
	private void drawShape(PRadialMenuSegment seg)
	{
	...
	private void drawText(PRadialMenuSegment seg)
	{
	...
	public void drawHintText(PRadialMenuSegment seg)
	{
	...
	{
		shapes = new PRadialMenuSegment[menuItems.size()];
		...
		for(int i=0; i < shapes.length; i++)
		{
			...
			PRadialMenuSegment seg = (PRadialMenuSegment) menuItems.get(i);
			seg.area = wedge;
...
//			System.out.println(seg.thetaLo + " " +seg.thetaMid + " " + seg.thetaHi);
	...
	public void layoutShapeText(PRadialMenuSegment seg)
	{
		/*
...
//		pg.smooth();
	...
	{
		PRadialMenuSegment seg = new PRadialMenuSegment(p,f,s,c);
		menuItems.add(seg);
		createShapes();
	}
	...
	public void mouseEvent(MouseEvent e)
	{
		...
		for (int i=0; i < shapes.length; i++)
		{
			PRadialMenuSegment seg = shapes[i];
