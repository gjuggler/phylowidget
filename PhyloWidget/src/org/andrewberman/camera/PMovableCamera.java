...
public abstract class PMovableCamera extends Camera implements MouseWheelListener,
		KeyListener, MouseMotionListener, MouseListener
{
	...
	public PMovableCamera(PApplet p)
	{
		super();
		this.p = p;
	...
	public void scroll()
	{
		 ...
		 */
		if (mouseInside && !FocusManager.isModal() && enableSideScrolling)
		{
